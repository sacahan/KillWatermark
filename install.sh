...
<dict>
	...
	<array>
		<dict>
			...
			<dict>
				<key>default</key>
				<string>移除 Nano Banana Pro 浮水印</string>
			</dict>
			<key>NSMessage</key>
...
# 產生固定 UUID（避免每次安裝都不同）
INPUT_UUID="9802C4FA-8136-43E6-B590-9D11359AB39A"
OUTPUT_UUID="C7241150-19BC-4FA9-BD30-8A418D686C45"
ACTION_UUID="20AF5C3A-7C2A-4D90-92CD-8D2A22675E0F"
